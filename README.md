...
Maps emotional states to spectral properties — the intersection of psychology and graph theory
...
```bash
git clone https://github.com/SuperInstance/spectral-emotions
cd spectral-emotions
```
